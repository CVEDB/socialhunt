...
Socialhunt is not capable of determining if a given username exists or not.
...
As of 2019-11-30, the site causes Socialhunt to just hang.
...
no way distinguish between the results with the current design of Socialhunt.
...
for Socialhunt to check for usernames on this particular website.
...
Socialhunt is unable to check for username on this site because we will always get  a page which asks
...
As of 2021-09-04, House Mixes has issues connecting causing Socialhunt to freeze.
```json
  "House-Mixes.com": {
...
then of course causes false positives in Socialhunt's results.
...
As of 2022-05-1, FanCentro returns false positives. Will later in new version of Socialhunt.
