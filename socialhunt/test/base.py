...
class SocialhuntBaseTest(unittest.TestCase):
    def setUp(self):
        """Socialhunt Base Test Setup.

        Does common setup tasks for base Socialhunt tests.
        ...
        excluded_sites_path = os.path.join(os.path.dirname(os.path.realpath(socialhunt.__file__)), "tests/.excluded_sites")
        try:
    ...
    def username_check(self, username_list, site_list, exist_check=True):
        ...
        for username in username_list:
            results = socialhunt.socialhunt(username,
                                        site_data,
                                        self.query_notify,
                                        tor=self.tor,
